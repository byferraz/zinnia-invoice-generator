...
const ZinniaInvoiceGenerator = () => {
  ...
  const preloadedClients = [
    ...
    { id: 9, name: "Brasil Plural Investment Advisors LLC", taxId: "", address: "2601 S Bayshore Drive Unit 1200, Coconut Grove, FL 33133", address2: "", standardAmount: "500.00", standardSubject: "Service Maintenance, Operational Support and Basic Operations (December 2025)", taxRate: "0", hasTax: false }
  ];
